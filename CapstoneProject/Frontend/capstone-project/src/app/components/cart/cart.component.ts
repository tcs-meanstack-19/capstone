...
// import { AuthService } from '../auth/auth.service';  //auth service to authenticate user
...
export class CartComponent implements OnInit {
  ...
  constructor(private productService:ProductService, private router:Router, private route:ActivatedRoute, private toaster:ToastrService) { } // add private auth:AuthService
  ...
  checkoutCart(){
    ...
    for (var i = 0; i < cart.length; i++){
      ...
      checkoutItem = {
        ...
        quantity : item.quantity, 
        _userId: 1,  // dummy userid
        totalPrice : item.product.price * item.quantity
        // "userId" : this.auth.getUserById()}  // we need to get the user id after authentication
      }
